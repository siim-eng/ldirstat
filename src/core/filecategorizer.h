...
public:
    ...
    static inline const char *displayNameForType(FileType type) {
        if (type == FileType::Unknown) return "Unknown";
        if (type == FileType::Executable) return "Executable";
        if (type == FileType::Cache) return "Cache file";
        if (type == FileType::VersionedSharedLibrary) return "Versioned shared library";

        const std::size_t index = typeIndex(type);
        if (index >= kTypeDisplayNames_.size()) return nullptr;
        return kTypeDisplayNames_[index];
    }
...
private:
    ...
    static constexpr auto kExtensionTypes_ = std::to_array<FileTypeSpec>({
        ...
        {FileType::ExtA, "a", FileCategory::Library, "Static library"},
        {FileType::ExtAac, "aac", FileCategory::Music, "AAC audio"},
        {FileType::ExtApk, "apk", FileCategory::Package, "Android package"},
        {FileType::ExtAppImage, "appimage", FileCategory::Package, "AppImage package"},
        {FileType::ExtAvi, "avi", FileCategory::Video, "AVI video"},
        {FileType::ExtBak, "bak", FileCategory::BackupTemp, "Backup file"},
        {FileType::ExtBz2, "bz2", FileCategory::Compressed, "Bzip2 compressed"},
        {FileType::ExtC, "c", FileCategory::Source, "C source"},
        {FileType::ExtCPlusPlus, "c++", FileCategory::Source, "C++ source"},
        {FileType::ExtCc, "cc", FileCategory::Source, "C++ source"},
        {FileType::ExtClass, "class", FileCategory::ObjectGenerated, "Java class"},
        {FileType::ExtCommitMeta, "commitmeta", FileCategory::ObjectGenerated, "Commit metadata"},
        {FileType::ExtConf, "conf", FileCategory::Document, "Configuration file"},
        {FileType::ExtCp, "cp", FileCategory::Source, "C++ source"},
        {FileType::ExtCpp, "cpp", FileCategory::Source, "C++ source"},
        {FileType::ExtCrdownload, "crdownload", FileCategory::BackupTemp, "Chrome partial download"},
        {FileType::ExtCs, "cs", FileCategory::Source, "C# source"},
        {FileType::ExtCss, "css", FileCategory::Source, "CSS stylesheet"},
        {FileType::ExtCsv, "csv", FileCategory::Document, "CSV spreadsheet"},
        {FileType::ExtCxx, "cxx", FileCategory::Source, "C++ source"},
        {FileType::ExtDb, "db", FileCategory::Database, "Database file"},
        {FileType::ExtDb3, "db3", FileCategory::Database, "SQLite database"},
        {FileType::ExtDeb, "deb", FileCategory::Package, "Debian package"},
        {FileType::ExtDesktop, "desktop", FileCategory::Document, "Desktop entry"},
        {FileType::ExtDll, "dll", FileCategory::Library, "Dynamic-link library"},
        {FileType::ExtDocx, "docx", FileCategory::Document, "Word document"},
        {FileType::ExtDylib, "dylib", FileCategory::Library, "macOS dynamic library"},
        {FileType::Executable, "elf", FileCategory::Executable, "ELF executable"},
        {FileType::ExtErr, "err", FileCategory::Log, "Error log"},
        {FileType::Executable, "exe", FileCategory::Executable, "Windows executable"},
        {FileType::ExtFile, "file", FileCategory::ObjectGenerated, "Generated file"},
        {FileType::ExtFlac, "flac", FileCategory::Music, "FLAC lossless audio"},
        {FileType::ExtFlatpak, "flatpak", FileCategory::Package, "Flatpak package"},
        {FileType::ExtFlv, "flv", FileCategory::Video, "Flash video"},
        {FileType::ExtFrm, "frm", FileCategory::Database, "MySQL table definition"},
        {FileType::ExtGif, "gif", FileCategory::Image, "GIF image"},
        {FileType::ExtGo, "go", FileCategory::Source, "Go source"},
        {FileType::ExtGz, "gz", FileCategory::Compressed, "Gzip compressed"},
        {FileType::ExtH, "h", FileCategory::Source, "C/C++ header"},
        {FileType::ExtHh, "hh", FileCategory::Source, "C++ header"},
        {FileType::ExtHp, "hp", FileCategory::Source, "C++ header"},
        {FileType::ExtHpp, "hpp", FileCategory::Source, "C++ header"},
        {FileType::ExtHtml, "html", FileCategory::Document, "HTML document"},
        {FileType::ExtHxx, "hxx", FileCategory::Source, "C++ header"},
        {FileType::ExtI, "i", FileCategory::Source, "Preprocessed source"},
        {FileType::ExtIbd, "ibd", FileCategory::Database, "InnoDB tablespace"},
        {FileType::ExtIco, "ico", FileCategory::Image, "Icon image"},
        {FileType::ExtIni, "ini", FileCategory::Document, "INI configuration"},
        {FileType::ExtIso, "iso", FileCategory::DiskImage, "ISO disk image"},
        {FileType::ExtJava, "java", FileCategory::Source, "Java source"},
        {FileType::ExtJournal, "journal", FileCategory::Log, "Journal log"},
        {FileType::ExtJournalTilde, "journal~", FileCategory::Log, "Journal log backup"},
        {FileType::ExtJpeg, "jpeg", FileCategory::Image, "JPEG image"},
        {FileType::ExtJpg, "jpg", FileCategory::Image, "JPEG image"},
        {FileType::ExtJs, "js", FileCategory::Source, "JavaScript source"},
        {FileType::ExtJson, "json", FileCategory::Document, "JSON document"},
        {FileType::ExtJsx, "jsx", FileCategory::Source, "React JSX source"},
        {FileType::ExtKo, "ko", FileCategory::ObjectGenerated, "Kernel module"},
        {FileType::ExtKt, "kt", FileCategory::Source, "Kotlin source"},
        {FileType::ExtKts, "kts", FileCategory::Source, "Kotlin script"},
        {FileType::ExtLog, "log", FileCategory::Log, "Log file"},
        {FileType::ExtLz, "lz", FileCategory::Compressed, "Lzip compressed"},
        {FileType::ExtLz4, "lz4", FileCategory::Compressed, "LZ4 compressed"},
        {FileType::ExtM4a, "m4a", FileCategory::Music, "MPEG-4 audio"},
        {FileType::ExtMd, "md", FileCategory::Document, "Markdown document"},
        {FileType::ExtMdb, "mdb", FileCategory::Database, "Access database"},
        {FileType::ExtMkv, "mkv", FileCategory::Video, "Matroska video"},
        {FileType::ExtMm, "mm", FileCategory::Source, "Objective-C++ source"},
        {FileType::ExtMov, "mov", FileCategory::Video, "QuickTime video"},
        {FileType::ExtMp3, "mp3", FileCategory::Music, "MP3 audio"},
        {FileType::ExtMp4, "mp4", FileCategory::Video, "MPEG-4 video"},
        {FileType::ExtMyd, "myd", FileCategory::Database, "MyISAM data"},
        {FileType::ExtMyi, "myi", FileCategory::Database, "MyISAM index"},
        {FileType::ExtO, "o", FileCategory::ObjectGenerated, "Object file"},
        {FileType::ExtObj, "obj", FileCategory::ObjectGenerated, "Object file"},
        {FileType::ExtOdp, "odp", FileCategory::Document, "ODP presentation"},
        {FileType::ExtOds, "ods", FileCategory::Document, "ODS spreadsheet"},
        {FileType::ExtOdt, "odt", FileCategory::Document, "ODT document"},
        {FileType::ExtOgg, "ogg", FileCategory::Music, "Ogg Vorbis audio"},
        {FileType::ExtOld, "old", FileCategory::BackupTemp, "Old backup"},
        {FileType::ExtOut, "out", FileCategory::Log, "Output log"},
        {FileType::ExtPart, "part", FileCategory::BackupTemp, "Partial download"},
        {FileType::ExtPdf, "pdf", FileCategory::Document, "PDF document"},
        {FileType::ExtPid, "pid", FileCategory::Log, "Process ID file"},
        {FileType::ExtPl, "pl", FileCategory::Source, "Perl source"},
        {FileType::ExtPng, "png", FileCategory::Image, "PNG image"},
        {FileType::ExtPptx, "pptx", FileCategory::Document, "PowerPoint presentation"},
        {FileType::ExtPyc, "pyc", FileCategory::ObjectGenerated, "Python bytecode"},
        {FileType::ExtPy, "py", FileCategory::Source, "Python source"},
        {FileType::ExtQcow2, "qcow2", FileCategory::DiskImage, "QEMU disk image"},
        {FileType::ExtRar, "rar", FileCategory::Archive, "RAR archive"},
        {FileType::ExtRb, "rb", FileCategory::Source, "Ruby source"},
        {FileType::ExtRpm, "rpm", FileCategory::Package, "RPM package"},
        {FileType::ExtRs, "rs", FileCategory::Source, "Rust source"},
        {FileType::ExtRtf, "rtf", FileCategory::Document, "Rich text document"},
        {FileType::ExtS, "s", FileCategory::Source, "Assembly source"},
        {FileType::ExtScss, "scss", FileCategory::Source, "SCSS stylesheet"},
        {FileType::ExtService, "service", FileCategory::Document, "Systemd service unit"},
        {FileType::ExtSh, "sh", FileCategory::Source, "Shell script"},
        {FileType::ExtSnap, "snap", FileCategory::Package, "Snap package"},
        {FileType::ExtSo, "so", FileCategory::Library, "Shared library"},
        {FileType::ExtSql, "sql", FileCategory::Source, "SQL source"},
        {FileType::ExtSqlite, "sqlite", FileCategory::Database, "SQLite database"},
        {FileType::ExtSqlite3, "sqlite3", FileCategory::Database, "SQLite database"},
        {FileType::ExtSvg, "svg", FileCategory::Image, "SVG vector image"},
        {FileType::ExtSwp, "swp", FileCategory::BackupTemp, "Vim swap file"},
        {FileType::ExtTar, "tar", FileCategory::Archive, "Tar archive"},
        {FileType::ExtTbz2, "tbz2", FileCategory::Archive, "Tar+bzip2 archive"},
        {FileType::ExtTgz, "tgz", FileCategory::Archive, "Tar+gzip archive"},
        {FileType::ExtTiff, "tiff", FileCategory::Image, "TIFF image"},
        {FileType::ExtTmp, "tmp", FileCategory::BackupTemp, "Temporary file"},
        {FileType::ExtToml, "toml", FileCategory::Document, "TOML document"},
        {FileType::ExtTs, "ts", FileCategory::Source, "TypeScript source"},
        {FileType::ExtTsx, "tsx", FileCategory::Source, "React TSX source"},
        {FileType::ExtTxt, "txt", FileCategory::Document, "Text file"},
        {FileType::ExtUi, "ui", FileCategory::Source, "Qt UI form"},
        {FileType::ExtVmdk, "vmdk", FileCategory::DiskImage, "VMware disk image"},
        {FileType::ExtWasm, "wasm", FileCategory::ObjectGenerated, "WebAssembly binary"},
        {FileType::ExtWav, "wav", FileCategory::Music, "WAV audio"},
        {FileType::ExtWebm, "webm", FileCategory::Video, "WebM video"},
        {FileType::ExtWebp, "webp", FileCategory::Image, "WebP image"},
        {FileType::ExtWma, "wma", FileCategory::Music, "WMA audio"},
        {FileType::ExtWmv, "wmv", FileCategory::Video, "WMV video"},
        {FileType::ExtWoff2, "woff2", FileCategory::ObjectGenerated, "WOFF2 web font"},
        {FileType::ExtXlsx, "xlsx", FileCategory::Document, "Excel spreadsheet"},
        {FileType::ExtXlsm, "xlsm", FileCategory::Document, "Excel macro spreadsheet"},
        {FileType::ExtXml, "xml", FileCategory::Document, "XML document"},
        {FileType::ExtXz, "xz", FileCategory::Compressed, "XZ compressed"},
        {FileType::ExtYaml, "yaml", FileCategory::Document, "YAML document"},
        {FileType::ExtYml, "yml", FileCategory::Document, "YAML document"},
        {FileType::ExtZip, "zip", FileCategory::Archive, "ZIP archive"},
        {FileType::ExtZst, "zst", FileCategory::Compressed, "Zstandard compressed"},
        {FileType::ExtZstd, "zstd", FileCategory::Compressed, "Zstandard compressed"},
    });
    ...
    static constexpr std::array<const char *, kTypeCount> buildTypeDisplayNames() {
        std::array<const char *, kTypeCount> names{};

        for (const FileTypeSpec &spec : kExtensionTypes_) {
            const std::size_t index = typeIndex(spec.type);
            if (names[index] == nullptr) names[index] = spec.displayName;
        }
    ...
    static const std::array<const char *, kTypeCount> kTypeDisplayNames_;
